...
<form method="post" action="${initParam.rootPath}/updateMenu.do" enctype="multipart/form-data">
		<sec:csrfInput />
		<input type="hidden" name="menuNum" value="${requestScope.menu.menuNum}" />
		<input type="text" name="menuName" value="${requestScope.menu.menuName}">
		<input type="text" name="menuComment" value="${requestScope.menu.menuComment}">
		<input type="number" name="menuPrice" value="${requestScope.menu.menuPrice}">
	...
	<div class="row">
		<div class="col-sm-12">
			<span id="changeSpan">
				...
				<img id="menuPicture" src="${initParam.rootPath }/menuPicture/${requestScope.menu.menuPicture}" class="img-responsive" width="350px">
			</span>
